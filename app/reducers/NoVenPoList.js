import {GET_NO_VEN_PO_LIST ,SET_POLIST} from '../actions/NoVenPoList';
//import sql from 'mssql';
var Connection = require('tedious').Connection;
var Request = require('tedious').Request;

export default function noVenPoListReducer( noVenPoList = [{PONumber:1,Vendor:2,Address1:'1633 S US HWY 33'}], action) {
 // 	getPO();
  switch (action.type) {
    case GET_NO_VEN_PO_LIST:
    {
    	console.log('start getPO');
    	//getNoVenPoList(state);
    	//return state;
      return [{PONumber:2,Vendor:3,Address1:'515 E Hazel'}];
    }
    case SET_POLIST:
    {
...
//      options: {encrypt: false, database: 'cribmaster'}  
  ...
  state.push({PONumber:2,Vendor:3,Address1:'515 E Hazel'});
